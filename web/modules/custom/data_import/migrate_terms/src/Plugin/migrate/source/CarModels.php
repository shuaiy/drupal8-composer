 ...
 * implemented by this class is "car_models". This is the name that the migration
 ...
 * )
 */
class CarModels extends SqlBase {
  ...
  public function query() {
     ...
     * source plugin.
     */
    return $this->select('make_model_data', 'mmdm')
      ->fields('mmdm', ['make','model'])
